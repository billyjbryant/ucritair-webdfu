  ...
  return (obj, name) => {
    return desc(obj, name, {
      async get() {
        ...
        return ((_a5 = this.renderRoot) == null ? void 0 : _a5.querySelector(selector)) ?? null;
      }
    });
  };
}
...
function queryAssignedElements(options) {
  return (obj, name) => {
    ...
    return desc(obj, name, {
      get() {
        var _a5;
        const slotEl = (_a5 = this.renderRoot) == null ? void 0 : _a5.querySelector(slotSelector);
...
function mixinDelegatesAria(base) {
  ...
  _a5 = privateIgnoreAttributeChangesFor;
...
var Button = class extends buttonBaseClass {
  ...
  focus() {
    var _a5;
    (_a5 = this.buttonElement) == null ? void 0 : _a5.focus();
  }
  blur() {
    var _a5;
    (_a5 = this.buttonElement) == null ? void 0 : _a5.blur();
  }
  render() {
    var _a5;
    ...
    return html`
      ${(_a5 = this.renderElevationOrOutline) == null ? void 0 : _a5.call(this)}
...
function mixinConstraintValidation(base) {
  ...
  class ConstraintValidationElement extends base {
    ...
    [(_a5 = privateCustomValidationMessage, privateSyncValidity)]() {
      if (isServer) {
        return;
      }
...
var MultiActionChip = class extends Chip {
  ...
  handleKeyDown(event) {
    ...
    const isRtl2 = getComputedStyle(this).direction === "rtl";
    const forwards = isRtl2 ? isLeft : isRight;
    const isPrimaryFocused = (_a5 = this.primaryAction) == null ? void 0 : _a5.matches(":focus-within");
...
var Dialog = class extends dialogBaseClass {
  ...
  async show() {
    ...
    (_a5 = this.querySelector("[autofocus]")) == null ? void 0 : _a5.focus();
  ...
  handleClose() {
    ...
    this.escapePressedWithoutCancel = false;
    (_a5 = this.dialog) == null ? void 0 : _a5.dispatchEvent(new Event("cancel", { cancelable: true }));
  }
  handleKeydown(event) {
    if (event.key !== "Escape") {
      return;
  ...
  async animateDialog(animation) {
    var _a5;
    (_a5 = this.cancelAnimations) == null ? void 0 : _a5.abort();
  ...
  handleFocusTrapFocus(event) {
    ...
    if (!firstFocusableChild || !lastFocusableChild) {
      (_a5 = this.dialog) == null ? void 0 : _a5.focus();
      return;
    }
...
function isFocusable(element) {
  ...
  return ((_a5 = element.shadowRoot) == null ? void 0 : _a5.delegatesFocus) ?? false;
}
...
var Field = class extends LitElement {
  ...
  render() {
    ...
    const outline = (_a5 = this.renderOutline) == null ? void 0 : _a5.call(this, floatingLabel);
    const classes = {
      "disabled": this.disabled,
  ...
  animateLabelIfNeeded({ wasFocused, wasPopulated }) {
    ...
    (_a5 = this.labelAnimation) == null ? void 0 : _a5.cancel();
...
function slotHasContent(slot) {
  ...
  for (const node of slot.assignedNodes({ flatten: true })) {
    ...
    const isTextWithContent = node.nodeType === Node.TEXT_NODE && ((_a5 = node.textContent) == null ? void 0 : _a5.match(/\S/));
...
var ListItemEl = class extends listItemBaseClass {
  ...
  focus() {
    var _a5;
    (_a5 = this.listItemRoot) == null ? void 0 : _a5.focus();
  }
  click() {
...
function getFocusedElement(activeDoc = document) {
  ...
  while (activeEl && ((_a5 = activeEl == null ? void 0 : activeEl.shadowRoot) == null ? void 0 : _a5.activeElement)) {
...
var Menu = class extends LitElement {
  ...
  constructor() {
    ...
    this.beforeClose = async () => {
      ...
      if (!this.skipRestoreFocus) {
        (_b2 = (_a5 = this.lastFocusedElement) == null ? void 0 : _a5.focus) == null ? void 0 : _b2.call(_a5);
      }
      if (!this.quick) {
  ...
  close() {
    ...
    maybeSubmenu.forEach((item) => {
      var _a5;
      (_a5 = item.close) == null ? void 0 : _a5.call(item);
    });
  }
  show() {
    this.open = true;
...
var SubMenu = class extends LitElement {
  ...
  constructor() {
    ...
    this.onMouseenter = () => {
      ...
      if ((_a5 = this.menu) == null ? void 0 : _a5.open)
        return;
  ...
  onSlotchange() {
    ...
    this.item.ariaExpanded = "false";
    this.item.ariaHasPopup = "menu";
    if ((_a5 = this.menu) == null ? void 0 : _a5.id) {
  ...
  async onSubMenuKeydown(event) {
    ...
    (_a5 = this.item) == null ? void 0 : _a5.focus();
...
function mixinFocusable(base) {
  ...
  class FocusableElement extends base {
    ...
    [(_a5 = privateIsFocusable, _b2 = externalTabIndex, _c = isUpdatingTabIndex, updateTabIndex)]() {
...
function mixinOnReportValidity(base) {
  ...
  class OnReportValidityElement extends base {
    ...
    [(_a5 = privateCleanupFormListeners, _b2 = privateDoNotReportInvalid, _c = privateIsSelfReportingValidity, privateCallOnReportValidity)](invalidEvent) {
...
var Select = class extends selectBaseClass {
  ...
  get options() {
    var _a5;
    return ((_a5 = this.menu) == null ? void 0 : _a5.items) ?? [];
  }
  /**
  ...
  [(_a2 = VALUE, onReportValidity)](invalidEvent) {
    ...
    if (prevMessage === this.getErrorText()) {
      (_a5 = this.field) == null ? void 0 : _a5.reannounceError();
    }
  }
  update(changed) {
    if (!this.hasUpdated) {
  ...
  async firstUpdated(changed) {
    var _a5;
    await ((_a5 = this.menu) == null ? void 0 : _a5.updateComplete);
  ...
  handleKeydown(event) {
    ...
    if (isPrintableKey) {
      ...
      (_b2 = (_a5 = this.labelEl) == null ? void 0 : _a5.setAttribute) == null ? void 0 : _b2.call(_a5, "aria-live", "polite");
  ...
  async handleOpening(e) {
    var _a5, _b2, _c;
    (_b2 = (_a5 = this.labelEl) == null ? void 0 : _a5.removeAttribute) == null ? void 0 : _b2.call(_a5, "aria-live");
  ...
  click() {
    var _a5;
    (_a5 = this.field) == null ? void 0 : _a5.click();
  }
  [createValidator]() {
...
var Slider = class extends sliderBaseClass {
  ...
  focus() {
    var _a5;
    (_a5 = this.inputEnd) == null ? void 0 : _a5.focus();
  }
  willUpdate(changed) {
    var _a5, _b2;
    this.renderValueStart = changed.has("valueStart") ? this.valueStart : (_a5 = this.inputStart) == null ? void 0 : _a5.valueAsNumber;
  ...
  updated(changed) {
    ...
    if (changed.has("range") || changed.has("renderValueStart") || changed.has("renderValueEnd") || this.isUpdatePending) {
      const startNub = (_a5 = this.handleStart) == null ? void 0 : _a5.querySelector(".handleNub");
...
var Tab = class extends tabBaseClass {
  ...
  getKeyframes(previousTab) {
    ...
    const from = {};
    const fromRect = ((_a5 = previousTab[INDICATOR]) == null ? void 0 : _a5.getBoundingClientRect()) ?? {};
...
var _a4, _b;
var wrap = ENABLE_SHADYDOM_NOPATCH && ((_a4 = window.ShadyDOM) == null ? void 0 : _a4.inUse) && ((_b = window.ShadyDOM) == null ? void 0 : _b.noPatch) === true ? window.ShadyDOM.wrap : (node) => node;
...
var TextField = class extends textFieldBaseClass {
  ...
  handleFocusChange() {
    var _a5;
    this.focused = ((_a5 = this.inputOrTextarea) == null ? void 0 : _a5.matches(":focus")) ?? false;
  }
  handleInput(event) {
    this.dirty = true;
